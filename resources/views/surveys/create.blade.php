<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800">Create Survey</h2>
    </x-slot>
    ...
    <form action="{{ route('surveys.store') }}" method="POST" id="survey-form">
        ...
        <div class="card mb-6">
            <div class="mb-4">
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" class="input-field w-full" placeholder="e.g. Customer Satisfaction Survey" required>
                @error('title')
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="2" class="input-field w-full" placeholder="Brief description of your survey">{{ old('description') }}</textarea>
            </div>
        </div>
